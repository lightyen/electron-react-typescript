...
const TitleBar = () => {
	...
	return (
		<Titlebar>
			...
			<ControlPanel>
				<Control onClick={window_minimize} title={intl.formatMessage({ defaultMessage: "Minimize" })}>
					<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 10 1.5">
						<rect width="10" height="1.5" />
					</svg>
				</Control>
				{maximized ? (
					<Control onClick={window_restore} title={intl.formatMessage({ defaultMessage: "Restore" })}>
					...
					<Control onClick={window_maximize} title={intl.formatMessage({ defaultMessage: "Maximize" })}>
				...
				<Control
					...
					title={intl.formatMessage({ defaultMessage: "Quit" })}
				>
					<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 10 10">
